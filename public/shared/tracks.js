...
export const SWITCHBACK = [
  straight(L), ...chicane(), ...halfHill(), straight(L), straight(L), arc(RS, 90),  // A: 7
  ...chicane(), straight(L), arc(RS, 90),                                           // B: 3
  straight(L), ...chicane(), ...halfHill(), straight(L), straight(L), arc(RS, 90),  // C: 7 (=A)
...
export const RIVERSIDE = [
  straight(L + 0.37), ...chicane(), ...fullHill(), ...run(4), arc(RL, 90),         // A: 9 (+0.37 closes the loop)
  straight(L - 0.37), ...halfHill(), arc(RL, 90),                                  // B: 3 (−0.37 closes the loop)

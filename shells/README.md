...
dependency* of every TV shell (`shells.md`'s base-URL item). Moving it under
`shells/` would name it as one implementation among three when it is also the
thing the other two point at.

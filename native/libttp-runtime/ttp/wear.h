...
// track space (s, lat), and the renderer stamps them through vroad's PAINT
// channel: under the laid rubber, because a repair is the deck rather than
// something laid on it (see buildDeckPaint).
//

...
// standings board goes through its twin. (The auto-pause site, the one that was
// actually wrong, is pinned harder in `abi-vocabulary.test.js`, which requires
// the twin's answer to reach the effect walker rather than merely be called.)
//
...
test('the standings board goes through its live twin', () => {
